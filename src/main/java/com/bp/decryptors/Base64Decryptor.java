...
public class Base64Decryptor implements Decryptor {
    ...
    public JPanel createOperationPanel(ResultCallback callback) {
        ...
        decodeButton.addActionListener(e -> {
            ...
            if (input.isEmpty()) {
                JOptionPane.showMessageDialog(panel, "请输入要解码的Base64文本", "错误", JOptionPane.ERROR_MESSAGE);
                return;
            }
            try {
                ...
                JOptionPane.showMessageDialog(panel, "无效的Base64编码", "错误", JOptionPane.ERROR_MESSAGE);
            }
        });
